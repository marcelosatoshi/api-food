...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		if (rootCause instanceof InvalidFormatException) {
			return handleInvalidaFormatException((InvalidFormatException) rootCause, headers, status, request);
		} else if (rootCause instanceof PropertyBindingException) {
			return handlePropertyBindingException((PropertyBindingException) rootCause, headers, status, request);
		}

		ProblemType problemType = ProblemType.MENSAGEM_INCOMPREESIVEL;
		String detail = "O corpo da requisição está invádlido.  Verifique erro de sintaxe.";
	...
	private ResponseEntity<Object> handleValidacaoException(ValidacaoException ex, WebRequest request) {
		...
		return handleValidationInternal(ex, ex.getBinding(), new HttpHeaders(), HttpStatus.BAD_REQUEST, request);
	...
	private ResponseEntity<Object> handleValidationInternal(Exception ex, BindingResult bindingResult,
		...
		List<Problem.Object> problemObjects = bindingResult.getAllErrors().stream().map(objectErrors -> {
	...
	private ResponseEntity<Object> handleInvalidaFormatException(InvalidFormatException ex, HttpHeaders headers,
			HttpStatus status, WebRequest request) {
		...
		String detail = String.format(
				"A propriedade '%s' recebeu o valor '%s', "
						+ "que é de um tipo inválido. Corrije  e informe um valor compatível  com o tipo '%s' ",
