...
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao) values (2, 'Thai Delivery', 9.50, 2, utc_timestamp, utc_timestamp);
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao) values (3, 'Tuk Tuk Comida Indiana', 15, 1, utc_timestamp, utc_timestamp);
...
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao) values (6, 'Bar da Maria', 6, 4, utc_timestamp, utc_timestamp);
    ...
    insert into forma_pagamento (id, nome, descricao) values (1, 'Cartão de crédito', 'aaaaaaaa');
    insert into forma_pagamento (id, nome, descricao) values (2, 'Cartão de débito' , 'bbbbbb');
    insert into forma_pagamento (id, nome, descricao) values (3, 'Dinheiro', 'cccccccccc');
